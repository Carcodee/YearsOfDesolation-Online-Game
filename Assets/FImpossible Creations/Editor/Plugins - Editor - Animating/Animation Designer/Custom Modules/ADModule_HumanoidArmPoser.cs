    ...
    public class ADModule_HumanoidArmPoser : ADHumanoidMuclesModuleBase
    {
        ...
        public override void InspectorGUI_ModuleBody(float optionalBlendGhost, ADClipSettings_Main _anim_MainSet, AnimationDesignerSave s, ADClipSettings_CustomModules cModule, ADClipSettings_CustomModules.CustomModuleSet set)
        {
            ...
            if (Display == EDisplayMode.UpperArm)
            {
                ...
                val.x = EditorGUILayout.Slider("Upper Arm Stretch", vUpArm.GetVector2Value().x, -1f, 1f);
                val.y = EditorGUILayout.Slider("Upper Arm Twist In Out", vUpArm.GetVector2Value().y, -1f, 1f);
                vUpArm.SetValue(val);
            }
            ...
            if (Display == EDisplayMode.LowerArm)
            {
                ...
                val.x = EditorGUILayout.Slider("Lower Arm Stretch", vLowArm.GetVector2Value().x, -1f, 1f);
                val.y = EditorGUILayout.Slider("Lower Arm Twist In Out", vLowArm.GetVector2Value().y, -1f, 1f);
            ...
            if (Display == EDisplayMode.Hand)
            {
                ...
                val.x = EditorGUILayout.Slider("Hand Up Down", vHand.GetVector2Value().x, -1f, 1f);
                val.y = EditorGUILayout.Slider("Hand In Out", vHand.GetVector2Value().y, -1f, 1f);
                vHand.SetValue(val);
            }
            ...
            if (Display == EDisplayMode.Shoulder)
            {
                ...
                val.x = EditorGUILayout.Slider("Shoulder Down-Up", vShld.GetVector2Value().x, -1f, 1f);
                val.y = EditorGUILayout.Slider("Shoulder Front-Back", vShld.GetVector2Value().y, -1f, 1f);
                vShld.SetValue(val);
            }
