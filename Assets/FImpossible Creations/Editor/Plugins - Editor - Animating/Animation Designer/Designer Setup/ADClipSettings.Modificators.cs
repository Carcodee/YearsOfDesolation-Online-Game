        ...
        public partial class ModificatorSet : INameAndIndex
        {
            ...
            internal void DrawTopGUI(float animProgr, ADClipSettings_Main main, int i)
            {
                ...
                if (i > 0)
                    ...
                    {
                        EditorGUILayout.HelpBox("Make sure that overriding modificators are on the left of modificators list to not erase effect of other modificators!", MessageType.None);
                    }
