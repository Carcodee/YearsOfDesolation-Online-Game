...
namespace FIMSpace.FTools
{
    public partial class FimpIK_Limb : FIK_ProcessorBase
    {
        ...
        {
            float rotWeight = FootRotationWeight * IKWeight;
        ...
        public Vector3 GetDefaultFlexNormal()
        {
        ...
        public Vector3 GetOrientationDirection(Vector3 ikPosition, Vector3 orientationNormal)
        {
