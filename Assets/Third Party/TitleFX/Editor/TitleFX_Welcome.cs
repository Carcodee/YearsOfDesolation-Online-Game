...
{
    public class TitleFX_Welcome : EditorWindow
    {
        //sUBSCRIBE
        ...
        [MenuItem("Tools/OrangedKeys/Title FX Pack/About ", false, 0)]
        public static void ShowWindow()
        {
            EditorWindow editorWindow = GetWindow(typeof(TitleFX_Welcome), false, " About ", true);
