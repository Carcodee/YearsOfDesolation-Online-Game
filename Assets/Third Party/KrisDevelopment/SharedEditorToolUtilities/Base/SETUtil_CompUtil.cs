...
namespace SETUtil
{
	public static class CompUtil
	{
		...
		public static void ForceOrder(U.GameObject instance, ComponentOrderList col)
		{
			...
			if (instance == null)
			{
				throw new System.NullReferenceException("[SETUtil.CompUtil.Reorder ERROR] null reference. No instance GameObject provided!");
			}
		...
		/// <summary>
		/// Return the components array as an array of their respective types
		/// </summary>
		[System.Obsolete]
		public static System.Type[] ComponentsToTypes(U.Component[] compArr)
		{
			return compArr.Select(a => a.GetType()).ToArray();
		}
