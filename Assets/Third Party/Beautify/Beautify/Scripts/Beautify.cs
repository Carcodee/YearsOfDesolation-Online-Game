...
namespace BeautifyEffect {
    ...
    public partial class Beautify : MonoBehaviour {
        ...
        const string BEAUTIFY_BUILD_HINT = "BeautifyBuildHint213b2";
...
#if UNITY_EDITOR
        public static UnityEngine.CameraType captureCameraType =UnityEngine.CameraType.SceneView;
        ...
        void ConfigureRenderScale() {
            ...
            if (Camera.current.cameraType == UnityEngine.CameraType.SceneView) return;
        ...
        protected virtual void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            if (allowExtraEffects) {
                ...
                if (_depthOfField) {
#if UNITY_EDITOR
                    if (cam != null && cam.cameraType != UnityEngine.CameraType.SceneView) {
